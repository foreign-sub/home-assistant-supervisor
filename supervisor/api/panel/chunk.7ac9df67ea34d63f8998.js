              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  if (
                    ...
                    var n = "symbol" === x(t) ? Symbol() : "__".concat(t);
        ...
        K = function(t) {
          ...
          var o = n.reduce(function(e, n, i) {
            return (
              e +
              (function(t) {
                if (t instanceof U) return t.cssText;
          ...
          for (
            ...
            if (null !== m) {
              if ((h++, 1 === m.nodeType)) {
                if (m.hasAttributes()) {
                  for (
                    var y = m.attributes, g = y.length, _ = 0, x = 0;
                    x < g;
                    x++
                  )
                    l(y[x].name, a) && _++;
                          ...
                          if (null != r) {
                            ...
                            if ("string" == typeof r) {
                              ...
                              if (
                                ...
                                y = w[0];
                                for (var z = w.length, I = 1; I < z; I += 1)
                                  y += w[I];
                                (y /= z), this._log("Token score average:", y);
                              }
                              var j = _.score;
                              y > -1 && (j = (j + y) / 2),
                              ...
                              for (var N = 0, P = r.length; N < P; N += 1)
                                this._analyze(
                                  {
                                    key: n,
                                    arrayIndex: N,
                ...
                if (null === f[O]) O++;
                  ...
                  if (p.has(b[A])) {
                    ...
                    if (null === I) {
                      var j = o(e, f[O]);
                      r(j, m[E]), (v[E] = j);
                    } else (v[E] = r(I, m[E])), a(e, I, f[O]), (f[z] = null);
                    E++;
                  } else s(f[A]), A--;
                else s(f[O]), O++;
              for (; E <= T; ) {
        ...
        return {
          ...
          action: function(e) {
            ...
            return function() {
              ...
              if (null != r) return r.then ? r.then(i) : i(r);
            };
          },
          setState: n,
