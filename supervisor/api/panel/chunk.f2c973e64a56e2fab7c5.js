          ...
          e.defineMode("jinja2", function () {
            ...
            function o(o, l) {
              ...
              if (l.incomment)
                return (
                  o.skipTo("#}")
                    ? (o.eatWhile(/\#|}/), (l.incomment = !1))
                    : o.skipToEnd(),
                  "comment"
                );
              if (l.intag) {
                if (l.operator) {
                  if (((l.operator = !1), o.match(n))) return "atom";
                  if (o.match(i)) return "number";
                }
                if (l.sign) {
                  if (((l.sign = !1), o.match(n))) return "atom";
                  if (o.match(i)) return "number";
                }
                if (l.instring)
                  return (
                    s == l.instring && (l.instring = !1), o.next(), "string"
                  );
                if ("'" == s || '"' == s)
                ...
                if (o.match(t)) return (l.operator = !0), "operator";
                if (o.match(r)) l.sign = !0;
                else if (o.eat(" ") || o.sol()) {
                  if (o.match(e)) return "keyword";
                  if (o.match(n)) return "atom";
                  if (o.match(i)) return "number";
                  o.sol() && o.next();
                } else o.next();
                return "variable";
    ...
    54: function (e, t, r) {
      ...
      (o = function () {
        ...
        function De(e) {
          ...
          return (
            N(e), !(!r || r.left == r.right) && (Ne = n.right - r.right < 3)
          );
        }
        var We,
          He =
          ...
          Fe =
            "oncopy" in (We = A("div")) ||
            (We.setAttribute("oncopy", "return;"),
            "function" == typeof We.oncopy),
          Pe = null,
          Ee = {},
          Ie = {};
        function Re(e) {
        ...
        var Ge = {};
        function Ue(e, t) {
          I(t, Ge.hasOwnProperty(e) ? Ge[e] : (Ge[e] = {}));
        }
        function Ve(e, t) {
          if (!0 === t) return t;
        ...
        function Ze(e) {
          ...
          for (
            var t = e.parent, r = G(t.lines, e), n = t.parent;
            n;
            t = n, n = n.parent
          )
          ...
          var o = (function (e, t, r) {
              for (
                ...
                if (
                  u &&
                  (!r ||
                    s + (u instanceof ct ? u.lookAhead : 0) <= o.modeFrontier)
                )
                  return s;
        ...
        function Jt(e, t) {
          var r = D("span", null, null, u ? "padding-right: .1px" : null),
            n = {
            ...
            if (f.test(t)) {
              ...
              for (var h = 0; ; ) {
                ...
                if (g) {
                  ...
                  s && a < 9 ? u.appendChild(A("span", [m])) : u.appendChild(m),
                ...
                if ("\t" == p[0]) {
                  var y = e.cm.options.tabSize,
                    b = y - (e.col % y);
                  (v = u.appendChild(A("span", q(b), "cm-tab"))).setAttribute(
                    "role",
                    "presentation"
                  ),
              ...
              if (v == p) {
                ...
                if (b)
                  for (var k = 0; k < b.length; k += 2)
                    b[k + 1] == v && (u += " " + b[k]);
                if (!f || f.from == p)
                  for (var M = 0; M < y.length; ++M) rr(t, 0, y[M]);
                if (f && (f.from || 0) == p) {
                  if (
                    (rr(
                      t,
        ...
        function pr(e, t) {
          !(function (e, t) {
            ...
            t.line.wrapClass
              ? (fr(t).className = t.line.wrapClass)
            ...
            t.cache.hasOwnProperty(l)
              ...
              : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
                ...
                (o = (function (e, t, r, n) {
                  ...
                  if (3 == l.nodeType) {
                    for (var d = 0; d < 4; d++) {
                      for (; u && oe(t.line.text.charAt(o.coverStart + u)); )
                        --u;
                      for (
                        ;
                      ...
                      if (
                        (i =
                          s && a < 9 && 0 == u && c == o.coverEnd - o.coverStart
                            ? l.parentNode.getBoundingClientRect()
                            : Er(L(l, u, c).getClientRects(), n)).left ||
                        i.right ||
                        0 == u
                      )
                        break;
                  ...
                  if (s && a < 9 && !u && (!i || (!i.left && !i.right))) {
                    var p = l.parentNode.getClientRects()[0];
                    i = p
                      ? {
                          left: p.left,
                          right: p.left + rn(e.display),
                          top: p.top,
                          bottom: p.bottom,
                        }
                      : Fr;
        ...
        function jr(e, t, r, n, i) {
          ...
          var l = jt(t);
          if (
            ("local" == n ? (l += Sr(e.display)) : (l -= e.display.viewOffset),
            "page" == n || "window" == n)
          ) {
        ...
        function Jr(e, t, r, n) {
          return (
            r || (r = Wr(e, t)), Zr(e, t, r, jr(e, t, Hr(e, r, n), "line").top)
          );
        }
        function Qr(e, t, r, n) {
              ...
              : function (e, t, r, n, i, o, l) {
                  ...
                  if (s > 0) {
                    var u = 1 != a.level,
                      c = _r(
                        e,
                        tt(r, u ? a.from : a.to, u ? "after" : "before"),
                        "line",
                        t,
                        n
                      );
        ...
        function ln(e) {
          var t = tn(e.display),
            ...
            n =
              r &&
              Math.max(5, e.display.scroller.clientWidth / rn(e.display) - 3);
          return function (i) {
        ...
        function an(e, t, r, n) {
          ...
          if (n && 1 == u.xRel && (a = _e(e.doc, u.line).text).length == u.ch) {
            ...
            u = tt(
              ...
              Math.max(
                0,
                Math.round((o - Mr(e.display).left) / rn(e.display)) - c
              )
            );
          }
          return u;
          ...
          function f(t, r, n) {
            ...
            return (
              (function (e, t, r, n) {
                ...
                i || n(t, r, "ltr");
              })(g, r || 0, null == n ? d : n, function (e, t, i, f) {
                var m = "ltr" == i,
                  v = h(e, m ? "left" : "right"),
          ...
          e.scrollToPos) &&
            (function (e, t) {
              ...
              (function (e, t, r, n) {
                ...
                t,
                at(n, e.scrollToPos.from),
                at(n, e.scrollToPos.to),
          ...
          return (
            ...
            (function (e, t, r) {
              ...
              function s(t) {
                var r = t.nextSibling;
                return (
                  u && b && e.display.currentWheelTarget == t
                    ? (t.style.display = "none")
                    : t.parentNode.removeChild(t),
                  r
                );
              }
              for (var a = n.view, c = n.viewFrom, f = 0; f < a.length; f++) {
                var d = a[f];
                if (d.hidden);
                  ...
                  d.changes &&
                    (G(d.changes, "gutter") > -1 && (h = !1), cr(e, d, c, r)),
                    h &&
                      (N(d.lineNumber),
        ...
        function ui(e) {
          ...
          if (
            ...
            for (
              var n = on(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
        ...
        function ci(e) {
          ...
          var t = e.doc,
            r = et(e.options, t.first + t.size - 1),
            n = e.display;
        ...
        function bi(e, t) {
          ...
          if ((i && a) || (o && c)) {
            if (o && b && u)
              e: for (var f = t.target, h = l.view; f != s; f = f.parentNode)
            ...
            if (i && !r && !d && null != mi)
              return (
                o && c && zn(e, Math.max(0, s.scrollTop + o * mi)),
        ...
        s ? (mi = -0.53) : r ? (mi = 15) : f ? (mi = -0.7) : h && (mi = -1 / 3);
        var wi = function (e, t) {
        ...
        (wi.prototype.primary = function () {
          ...
          (wi.prototype.equals = function (e) {
            ...
            for (var t = 0; t < this.ranges.length; t++) {
              var r = this.ranges[t],
                n = e.ranges[t];
              if (!nt(r.anchor, n.anchor) || !nt(r.head, n.head)) return !1;
            }
            return !0;
          }),
          ...
          (wi.prototype.contains = function (e, t) {
            ...
            for (var r = 0; r < this.ranges.length; r++) {
              var n = this.ranges[r];
              if (rt(t, n.from()) >= 0 && rt(e, n.to()) <= 0) return r;
            }
            return -1;
          });
        var xi = function (e, t) {
        ...
        function Ti(e, t, r) {
          return e.line == t.line
            ? tt(r.line, e.ch - t.ch + r.ch)
            : tt(r.line + (e.line - t.line), e.ch);
        }
        function Ni(e) {
          (e.doc.mode = Be(e.options, e.doc.modeOption)), Oi(e);
        }
        function Oi(e) {
        ...
        function Ii(e, t, r, n) {
          ...
          if (
            ...
            (l = $(o.changes)),
              0 == rt(t.from, t.to) && 0 == rt(t.from, l.to)
                ? (l.to = ki(t))
                : o.changes.push(Pi(e, t));
          else {
            var a = $(i.done);
            for (
              (a && a.ranges) || Bi(e.sel, i.done),
        ...
        function Vi(e, t) {
          var r = (function (e, t) {
              var r = t["spans_" + e.id];
              if (!r) return null;
              for (var n = [], i = 0; i < t.text.length; ++i) n.push(Ui(r[i]));
              return n;
            })(e, t),
            n = Tt(e, t);
          if (!r) return n;
        ...
        function so(e, t, r) {
          if (e.cm) {
            if (!e.cm.curOp) return Jn(e.cm, so)(e, t, r);
        ...
        function fo(e, t, r, n) {
          if (e.cm && !e.cm.curOp) return Jn(e.cm, fo)(e, t, r, n);
          if (t.to.line < e.first)
            ...
            t.to.line > o &&
              ...
              e.cm
                ...
                : Di(e, t, n),
              Ji(e, r, j),
              e.cantEdit && no(e, tt(e.firstLine(), 0)) && (e.cantEdit = !1);
          }
        }
        function ho(e, t, r, n, i) {
          var o;
          n || (n = r),
            rt(n, r) < 0 && ((r = (o = [n, r])[0]), (n = o[1])),
        ...
        function vo(e, t, r, n) {
          var i = t,
            o = t;
          return (
            "number" == typeof t ? (o = _e(e, st(e, t))) : (i = Ze(t)),
        ...
        (xi.prototype.from = function () {
          ...
          (bo.prototype = {
            ...
            removeInner: function (e, t) {
              ...
              if (
                this.size - t < 25 &&
                (this.children.length > 1 || !(this.children[0] instanceof yo))
              ) {
                var s = [];
                this.collapse(s),
                  (this.children = [new yo(s)]),
        ...
        function xo(e, t, r) {
          jt(t) < ((e.curOp && e.curOp.scrollTop) || e.doc.scrollTop) &&
            On(e, r);
        }
        ...
        function ko(e, t, r, n, i) {
          ...
          if (e.cm && !e.cm.curOp) return Jn(e.cm, ko)(e, t, r, n, i);
          var o = new So(e, i),
            l = rt(t, r);
          ...
          if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
              ...
              e && !this.collapsed
                ? fn(e, Ze(l), "text")
                : e &&
                  (null != s.to && (i = Ze(l)), null != s.from && (n = Ze(l))),
        ...
        (Mo.prototype.clear = function () {
          ...
          we(Mo);
        var No = 0,
          Oo = function e(t, r, n, i, o) {
            if (!(this instanceof e)) return new e(t, r, n, i, o);
            null == n && (n = 0),
              bo.call(this, [new yo([new _t("", null)])]),
              (this.first = n),
        ...
        (Oo.prototype = Q(bo.prototype, {
          ...
          setValue: ei(function (e) {
            ...
            so(
              ...
              this.cm && Dn(this.cm, 0, 0),
              Zi(this, Si(t), j);
          }),
          replaceRange: function (e, t, r, n) {
            ho(this, e, (t = at(this, t)), (r = r ? at(this, r) : t), n);
          },
          ...
          getLineHandle: function (e) {
            if (Qe(this, e)) return _e(this, e);
          },
          getLineNumber: function (e) {
            return Ze(e);
          },
          getLineHandleVisualStart: function (e) {
            return "number" == typeof e && (e = _e(this, e)), Rt(e);
          },
          lineCount: function () {
            return this.size;
          },
          ...
          setCursor: ei(function (e, t, r) {
            qi(
              this,
              at(this, "number" == typeof e ? tt(e, t || 0) : e),
              null,
              r
            );
          }),
          setSelection: ei(function (e, t, r) {
            qi(this, at(this, e), at(this, t || e), r);
          }),
          ...
          extendSelectionsBy: ei(function (e, t) {
            _i(this, ut(this, Z(this.sel.ranges, e)), t);
          }),
          ...
          lineInfo: function (e) {
            ...
            if ("number" == typeof e) {
              ...
              if (((t = e), !(e = _e(this, e)))) return null;
          ...
          addLineClass: ei(function (e, t, r) {
            return vo(this, e, "gutter" == t ? "gutter" : "class", function (
              e
            ) {
              var n =
                "text" == t
          ...
          findMarksAt: function (e) {
            var t = [],
              r = _e(this, (e = at(this, e)).line).markedSpans;
            if (r)
              for (var n = 0; n < r.length; ++n) {
                var i = r[n];
          ...
          transposeChars: function (e) {
            return Zn(e, function () {
              for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++)
                if (t[n].empty()) {
                  var i = t[n].head,
                    o = _e(e.doc, i.line).text;
                  if (o)
                    if (
                      (i.ch == o.length && (i = new tt(i.line, i.ch - 1)),
                      i.ch > 0)
                    )
        ...
        function ol(e, t, r, n) {
          var i = (function (e, t, r) {
            ...
            return (
              (e.options.extraKeys && jo(t, e.options.extraKeys, r, e)) ||
              ...
              window.focus(),
                ...
                (n &&
                  ...
                  (1 == i
                    ? n
                      ? (function (e, t, r, n) {
                          s ? setTimeout(E(xn, e), 0) : (e.curOp.focus = H());
                          var i,
                            o = (function (e, t, r) {
                          ...
                          "single" == r &&
                          (i = l.contains(t)) > -1 &&
                          (rt((i = l.ranges[i]).from(), t) < 0 || t.xRel > 0) &&
                          (rt(i.to(), t) > 0 || t.xRel < 0)
                            ? (function (e, t, r, n) {
                                var i = e.display,
                                  o = !1,
                                  l = Jn(e, function (t) {
                            ...
                            : (function (e, t, r, n) {
                                ...
                                n.addNew && !n.extend
                                  ? ((s = o.sel.contains(r)),
                                    (l = s > -1 ? u[s] : new xi(r, r)))
                                  : ((l = o.sel.primary()),
                                    (s = o.sel.primIndex));
                                if ("rectangle" == n.unit)
                                  n.addNew || (l = new xi(r, r)),
                                    (r = an(e, t, !0, !0)),
                                    (s = -1);
                                else {
                                  var c = gl(e, r, n.unit);
                                  l = n.extend
                                    ? Ki(l, c.anchor, c.head, n.extend)
                                    : c;
                                }
                                n.addNew
                                  ? -1 == s
                                    ? ((s = u.length),
                                      Zi(o, Ci(e, u.concat([l]), s), {
                                        scroll: !1,
                                        origin: "*mouse",
                                      }))
                                    : u.length > 1 &&
                                  ...
                                  if (0 != rt(f, t))
                                    if (((f = t), "rectangle" == n.unit)) {
                                      for (
                                        var i = [],
                                          u = e.options.tabSize,
                                          c = R(_e(o, r.line).text, r.ch, u),
                                          d = R(_e(o, t.line).text, t.ch, u),
                                          h = Math.min(c, d),
                                          p = Math.max(c, d),
                                ...
                                function g(t) {
                                  (e.state.selectingText = !1),
                                    ...
                                    ge(i.wrapper.ownerDocument, "mousemove", m),
                                    ge(i.wrapper.ownerDocument, "mouseup", v),
                                    (o.history.lastSelOrigin = null);
                                }
                                var m = Jn(e, function (t) {
                                    0 !== t.buttons && Le(t)
                                      ? (function t(r) {
                                          var l = ++p;
                                          var s = an(
                      ...
                      : Me(e) == r.scroller && xe(e)
                    : 2 == i
                    ? (n && Xi(t.doc, n),
                      setTimeout(function () {
                        return r.input.focus();
                      }, 20))
                    : 3 == i && (k ? t.display.input.onContextMenu(e) : Cn(t)));
            }
        }
        function gl(e, t, r) {
          ...
          (function (e) {
            ...
            he(t.scroller, "touchstart", function (i) {
                ...
                if (
                  ...
                  (l =
                    !n.prev || o(n, n.prev)
                      ...
                      ? e.findWordAt(s)
                      : new xi(tt(s.line, 0), at(e.doc, tt(s.line + 1, 0)))),
              ...
              (t.dragFunctions = {
                ...
                start: function (t) {
                  return (function (e, t) {
                    if (s && (!e.state.draggingText || +new Date() - Ao < 100))
                      ke(t);
                    else if (
                      !ve(e, t) &&
                      !Cr(e.display, t) &&
            ...
            he(l, "keyup", function (t) {
              ...
              he(l, "keydown", Jn(e, al)),
              he(l, "keypress", Jn(e, cl)),
        ...
        function Tl(e, t, r, n) {
          ...
          null == r && (r = "add"),
            "smart" == r &&
              (o.mode.indent ? (i = pt(e, t).state) : (r = "prev"));
          ...
          "prev" == r
            ? (u = t > o.first ? R(_e(o, t - 1).text, null, l) : 0)
            : "add" == r
          ...
          if ((d < u && (f += q(u - d)), f != c))
            return (
              ho(o, f, tt(t, 0), tt(t, c.length), "+input"),
              (s.stateAfter = null),
              !0
            );
          ...
          for (
            ...
            h.empty() &&
              (r && r > 0
                ...
                ? (g = tt(
                    g.line,
                    Math.min(_e(o, g.line).text.length, g.ch + $(a).length)
                  ))
                : s &&
                  Nl &&
                  Nl.lineWise &&
            ...
            if (
              ...
              (o = i
                ? (function (e, t, r, n) {
                    ...
                    var s,
                      a = function (e, r) {
                        return $o(t, e instanceof tt ? e.ch : e, r);
                      },
                      u = function (r) {
        ...
        function El(e, t, r, n) {
          ...
          if ("page" == n) {
            var a = Math.min(
              ...
              u = Math.max(a - 0.5 * tn(e.display), 3);
        ...
        function Ul(e, t, r) {
          var n = e.text.firstChild,
            i = !1;
          if (!t || !W(n, t)) return Bl(tt(Ze(e.line), 0), !0);
          ...
          if (f) return Bl(f, i);
          for (
            var d = s.nextSibling, h = l ? l.nodeValue.length - r : 0;
            d;
            d = d.nextSibling
          ) {
            if ((f = c(d, d.firstChild, 0))) return Bl(tt(f.line, f.ch - h), i);
        ...
        (Il.prototype.init = function (e) {
          ...
          function o(e) {
            if (!ve(n, e)) {
              ...
              P(s),
                setTimeout(function () {
                  n.display.lineSpace.removeChild(l),
                    a.focus(),
          ...
          (Il.prototype.pollContent = function () {
            ...
            if (
              ...
              s.ch == _e(n.doc, s.line).text.length &&
                s.line < n.lastLine() &&
                (s = tt(s.line + 1, 0)),
        ...
        (Vl.prototype.init = function (e) {
          ...
          (Vl.prototype.onContextMenu = function (e) {
            ...
            if (o && !d) {
              ...
              if (
                ...
                ke(e);
                he(window, "mouseup", function e() {
                  ge(window, "mouseup", e), setTimeout(m, 20);
                });
            ...
            function m() {
              if (
                ...
                s &&
                  a < 9 &&
                  n.scrollbars.setScrollTop((n.scroller.scrollTop = l)),
          ...
          (function (e) {
            ...
            (e.defineOption = r),
              ...
              r("workTime", 100),
              r("workDelay", 100),
              r("flattenSpans", !0, Oi, !0),
              r("addModeClass", !1, Oi, !0),
              r("pollInterval", 100),
          ...
          (function (e) {
            ...
            (e.prototype = {
              ...
              setOption: function (e, r) {
                ...
                (n[e] == r && "mode" != e) ||
                  ((n[e] = r),
                  t.hasOwnProperty(e) && Jn(this, t[e])(this, r, i),
              ...
              getStateAfter: function (e, t) {
                ...
                return pt(
                  this,
                  (e = st(r, null == e ? r.first + r.size - 1 : e)) + 1,
                  t
                ).state;
              },
              ...
              charCoords: function (e, t) {
                return Xr(this, at(this.doc, e), t || "page");
              },
              ...
              heightAtLine: function (e, t, r) {
                ...
                return (
                  jr(this, n, { top: 0, left: 0 }, t || "page", r || i).top +
              ...
              addWidget: function (e, t, r, n, i) {
                var o,
                  ...
                  s,
                  a = this.display,
                  u = (e = _r(this, at(this.doc, e))).bottom,
                  c = e.left;
                if (
              ...
              refresh: Qn(function () {
                ...
                cn(this),
                  ...
                  si(this.display),
                  (null == e || Math.abs(e - tn(this.display)) > 0.5) &&
                    sn(this),
                  me(this, "refresh", this);
              }),
        ...
        for (var Kl in Oo.prototype)
          Oo.prototype.hasOwnProperty(Kl) &&
            G(jl, Kl) < 0 &&
            (Ml.prototype[Kl] = (function (e) {
              return function () {
...
//# sourceMappingURL=chunk.f2c973e64a56e2fab7c5.js.map
