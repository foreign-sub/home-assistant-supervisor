(self.webpackJsonp = self.webpackJsonp || []).push([
  [ 9 ], {
    175 : function(e, t, r) {
      ...
      function E(e, t, r) {
        return (
            E = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(e, t, r) {
              var n = function(e, t) {
      ...
      }([ Object(n.d)("hassio-ingress-view") ], function(e, t) {
        var r = function(r) {
          function n() {
            var t, r, i, o;
            !function(e, t) {
            ...
            for (var a = arguments.length, c = new Array(a), l = 0; l < a; l++)
              c[l] = arguments[l];
            return i = this,
                   r = !(o = (t = O(n)).call.apply(t, [ this ].concat(c))) ||
        ...
        return {
          F: r, d: [
            ...
            },
            {
              ...
              key : "render",
              value : function() {
                return this._addon ? Object(n.e)(l(), this._addon.name,
            ...
            },
            {
              ...
              key : "updated",
              value : function(e) {
                if (E(O(r.prototype), "firstUpdated", this).call(this, e),
                    e.has("route")) {
                  var t = this.route.path.substr(1), n = e.get("route"),
              ...
              value : function(e) {
                ...
                return regeneratorRuntime.async(function(s) {
                  for (;;)
                    ...
                    case 0:
                      return s.prev = 0, s.next = 3,
                             regeneratorRuntime.awrap(Promise.all([
                               Object(o.b)(this.hass, e).catch(function() {
                    ...
                    case 3:
                      if (t = s.sent, r = c(t, 1), (n = r[0]).ingress) {
                        s.next = 8;
                        break
                      }
                      throw new Error("This add-on does not support ingress");
                    case 8:
                      this._addon = n, s.next = 16;
                      break;
                    case 11:
                      s.prev = 11, s.t0 = s.catch(0), console.error(s.t0),
                      alert(s.t0.message || "Unknown error starting ingress."),
                      history.back();
                    case 16:
                    case "end":
                      return s.stop()
...
//# sourceMappingURL=chunk.990ee58006b248f55d23.js.map