  ...
  [9],
  {
      ...
      (n = (function() {
        ...
        (function(t, e) {
            ...
            return t < 0 || t > 1 || n < 0 || n > 1
              ...
              : function(r) {
                  ...
                  for (var c = 0, l = 1; c < l; ) {
                    var u = (c + l) / 2,
                      d = o(t, n, u);
                    if (Math.abs(r - d) < 1e-5) return o(e, i, u);
                    d < r ? (c = u) : (l = u);
                  }
                  return o(e, i, u);
                };
          ...
          function c(t) {
            ...
            var n = v.exec(t);
            return n
              ? a(Number(n[1]), { start: h, middle: f, end: m }[n[2]])
              : g[t] || p;
          }
          function l(t, e, n) {
            if (null == e) return w;
          ...
          var h = 1,
            ...
            _ = "\\s*(-?\\d+\\.?\\d*|-?\\.\\d+)\\s*",
            b = new RegExp(
              "cubic-bezier\\(" + _ + "," + _ + "," + _ + "," + _ + "\\)"
            ),
            v = /steps\(\s*(\d+)\s*,\s*(start|middle|end)\s*\)/,
            w = 0,
            x = 1,
            T = 2,
            k = 3;
          ...
          !(function(t, e, n) {
            ...
            (function(t, e, n) {
              ...
              (e.restart = function() {
                return (
                  d ||
                    ((d = !0), requestAnimationFrame(function() {}), (p = !0)),
                  p
                );
              }),
        ...
        (function(t, e, n) {
          ...
          function r() {
            for (var t = !1; c.length; ) c.shift()._updateChildren(), (t = !0);
            return t;
          }
          var o = function t(e) {
            if (
          ...
          if (
            ...
            if (
              ...
              "entry" === t
                ...
                : "exit" === t &&
                  this.updateStyles({ "--paper-tooltip-delay-out": e + "ms" });
            }
    ...
    126: function(t, e, n) {
              ...
              if (!e.constructor.hasOwnProperty("_observers")) {
                ...
                (e.constructor._observers = new Map()),
                  i.forEach(function(t, n) {
                    return e.constructor._observers.set(n, t);
                  });
              }
            } else {
              e.constructor._observers = new Map();
          ...
          return (
            ...
            (e.prototype.setDisabled = function(t) {
              this.adapter_.setNativeControlDisabled(t),
                t
                  ? this.adapter_.addClass(T.DISABLED)
            ...
            (e.prototype.updateCheckedStyling_ = function(t) {
              t
                ? this.adapter_.addClass(T.CHECKED)
          ...
          (i = [
            ...
            },
            {
              ...
              value: function() {
                return Object(r.e)(
                  O(),
                  Object(w.a)({ interactionNode: this }),
                  this._changeHandler
                );
              }
            },
      ...
      Object(i.b)(
        ...
        Object(i.b)(
          [Object(r.g)(".mdc-switch")],
          N.prototype,
          "mdcRoot",
          void 0
        ),
        Object(i.b)([Object(r.g)("input")], N.prototype, "formElement", void 0),
        Object(i.b)(
          [Object(r.g)(".mdc-switch__thumb-underlay")],
          N.prototype,
          "rippleNode",
          void 0
        );
    ...
    127: function(t, e, n) {
      ...
      Object(l.a)({
        ...
        get contentElement() {
          for (
            var t = Object(u.a)(this.$.content).getDistributedNodes(),
              e = 0,
              n = t.length;
            e < n;
            e++
    ...
    128: function(t, e, n) {
      ...
      var r = n(6),
        ...
        a = n(38),
        s = n(23),
        c = [a.a, s.a, { hostAttributes: { role: "option", tabindex: "0" } }];
      function l() {
        var t = (function(t, e) {
          e || (e = t.slice(0));
          return Object.freeze(
