  ...
  function(e, t, n) {
    (function(r) {
      ...
      !(function(r) {
        ...
        function f(e, t) {
          if (t) {
            if (f.escapeTest.test(e))
              return e.replace(f.escapeReplace, function(e) {
                return f.replacements[e];
              });
          } else if (f.escapeTestNoEncode.test(e))
            return e.replace(f.escapeReplaceNoEncode, function(e) {
              return f.replacements[e];
            });
          return e;
        }
        ...
        (l._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~"),
          (l.em = m(l.em)
            .replace(/punctuation/g, l._punctuation)
            .getRegex()),
          (l._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g),
          (l._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
          (l._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
          (l.autolink = m(l.autolink)
            .replace("scheme", l._scheme)
            .replace("email", l._email)
            .getRegex()),
          (l._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
          (l.tag = m(l.tag)
            .replace("comment", s._comment)
            ...
            for (var t, n, r, i, o, s, a = ""; e; )
              if ((o = this.rules.escape.exec(e)))
                ...
                if (l > -1) {
                  ...
                  (o[2] = o[2].substring(0, l)),
                    (o[0] = o[0].substring(0, u).trim()),
                    (o[3] = "");
                }
                (e = e.substring(o[0].length)),
                  (this.inLink = !0),
          ...
          (p.prototype.strong = p.prototype.em = p.prototype.codespan = p.prototype.del = p.prototype.text = function(
            e
          ) {
            return e;
          }),
          (p.prototype.link = p.prototype.image = function(e, t, n) {
            return "" + n;
          }),
  ...
  function(e, t, n) {
    ...
    var r,
      ...
      c = function(e, t) {
        ...
        return (
          r || (r = Object.assign({}, l.a.whiteList, { "ha-icon": ["icon"] })),
          o.allowSvg
            ? (i ||
                (i = Object.assign({}, r, {
